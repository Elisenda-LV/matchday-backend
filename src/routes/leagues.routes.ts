...
import { deleteLeague, getLeagueById, getLeagueTeams, getListLeagues, postLeague, updateLeague } from "../controllers/leagues.controller";
...
routerLeague.get('/id:/teams', getLeagueTeams);
